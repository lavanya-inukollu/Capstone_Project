...
//    //    @HystrixCommand(fallbackMethod = "logincheckfallback",commandKey = "loginkey",groupKey = "login")
////    @HystrixProperty(name = "execution.isolation.thread.timeoutInMilliseconds",value = "1_000")
    @HystrixCommand(fallbackMethod = "logincheckfallback", commandProperties = {
...
//            get jwt from jwtservice method by passing result oject
                ...
                return new ResponseEntity<>("Authenication failes", HttpStatus.NOT_FOUND);
